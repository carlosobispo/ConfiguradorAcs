...
<head>
	...
	$(function(){
		...
		$( "#form-ActualizarEmisor" ).validate({
	           rules: {
	        	   		"emisor.intIdIssuer": {
...
<div class="col-lg-12">
	...
	<div class="panel panel-default">
		<div class="panel-heading">Actualizar Emisor</div>
		<div class="panel-body">
			<div class="row">
				<!--  form-crearEmisor -->
				<form  id="form-ActualizarEmisor" class="form-horizontal" method="post" action="actualizarEmisor" >
					<s:hidden  name="operacionValidate" value="validateActualizarEmisor"/>
					...
					<div class="col-lg-12">
						<div class="form-group">
							...
							<div class="col-xs-6">
									<s:label cssClass="form-control" name="brandBean.svcName"/>
							</div>
						</div>
					...
					<div class="col-lg-12">
						<div class="form-group">
							...
							<div class="col-xs-6">
								<s:label cssClass="form-control" name="emisor.intIdIssuer" id="emisor_intIdIssuer"/>
							</div>
						</div>
					</div>
					<div class="col-lg-12">
					...
					<div class="col-lg-12">
						<div class="form-group">
							...
							<div class="col-xs-6">
									<s:radio name="emisor.intIdstate" list="#{'1':'Habilitado','0':'Deshabilitado'}" />	
							</div>							
						</div>
					</div>			
					...
					<s:hidden  name="emisor.intIdIssuer"/>
					<s:hidden  name="brandBean.svcName"/>
					<s:hidden  name="brandBean.intIdBrand"/>
			
					<div class="col-lg-12">
						<div class="form-group">
							<div class="col-xs-11">
									<input type="submit" style=" float: right;display: inline-block; font-weight: 700;margin-bottom: 5px; max-width: 100%;" class="btn btn-primary" value="Actualizar">		
				     		</div>						
						</div>
					</div>					
