...
public class PopupADCEBean implements Serializable {
	...
	private Integer vc_UserRandon;
	private Integer in_pistalCode;
	...
	public PopupADCEBean() {

	}

	public PopupADCEBean(Integer in_idPopupADCE, Integer in_idIssuer,
			Integer in_cashierPassword, Integer in_cardPassword,
			Integer in_bankingPassword, Integer in_cvv2,
			Integer in_identityCard, Integer in_dateExpiry,
			Integer in_dateBirth, Integer in_phoneNumber,
			Integer in_idCardRange, Integer in_value1, Integer in_value2,
			Integer in_value3, Integer in_value4, String vc_valueName1,
			String vc_valueName2, String vc_valueName3, String vc_valueName4,
			Integer vc_UserRandon, Integer in_pistalCode,
			Integer in_customerNumber, Integer in_accountOpenDate,
			Integer in_paymentLimitDate, Integer in_minimunPayment,
			Integer in_previousBalance, Integer in_creditLimit,
		...
		this.vc_UserRandon = vc_UserRandon;
		this.in_pistalCode = in_pistalCode;
	...
	public Integer getVc_UserRandon() {
		return vc_UserRandon;
	}
	public void setVc_UserRandon(Integer vc_UserRandon) {
		this.vc_UserRandon = vc_UserRandon;
	}
	
	@Column(name="IN_POSTALCODE")
	public Integer getIn_pistalCode() {
		return in_pistalCode;
	}
	public void setIn_pistalCode(Integer in_pistalCode) {
		this.in_pistalCode = in_pistalCode;
	}
	...
	public String toString() {
		...
		sb.append("IN_USERANDOM= "+vc_UserRandon +", ");
		sb.append("IN_POSTALCODE= "+in_pistalCode +", ");
