...
@Entity
@Table(name="T3DS_DATACONFIG" , schema="SQMACS")
//@Table(name="T3DS_DATACONFIG")
public class DataConfigBean implements Serializable{
	...
	public static class Id implements Serializable{
		...
		@Column(name="VC_KEYNAME",length=150)	
	...
	public DataConfigBean(Id id,String svcValue,String svcDescription){
		this.id = id;
	...
	@Column(name="VC_VALUE",length=5500)	
	...
	@Column(name="VC_DESCRIPTION",length=200)	
